...
public class CopyHander extends SimpleChannelInboundHandler<Object> {

    private final org.slf4j.Logger logger =  LoggerFactory.getLogger(CopyHander.class);
    // 用于服务器端web套接字打开和关闭握手
...
//        System.out.println();
        logger.info("客户端与服务端连接开启，客户端remoteAddress：" + ctx.channel().remoteAddress());
    }
...
//        System.out.println();
    ...
    private void handWebsocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        if (frame instanceof TextWebSocketFrame) {
            ...
            logger.info("收到客户端" + UserInfoManager.parseChannelRemoteAddr(ctx.channel()) + "的消息==》"+requestMsg);
